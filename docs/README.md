...
- По верхним и нижним точкам мы строим канал такого движения (верхние максимумы и нижние минимумы – каждые 15 минут)
- Учитываем переход свечи за линию медианы (средний курс – который определяется на каждый час, с учетом предыдущих максимальных и минимальных значений за предыдущие 4 часа).
- Выход курса валюты за границы канала интерпретируем, как начало неестественной манипуляции курсом и можем рассматривать такую ситуацию, как сигнал.
...
- Также соотношение "цены равенства объемов" нам показывает насколько рынок находится в балансе/дисбалансе.

### Pump & Dump индикатор
Перед пампом или дампом происходит резкое изменение суммарного объемов ордеров в биржевом стакане, если изменение вышло за рамки 5% в ту или иную сторону, мы считаем это сигналом к резкому изменению цены в ближайший краткосрочный период.
...
### NextAI signal
Анализ последней закрытой свечи на условие пробития канала предсказания и условия того, чтобы свеча не пересекала среднюю линию этого канала. Так же должно выполняться условие одновременное падение/поднятие всех трех линий предсказаний для этой свечи по сравнению с предыдущей.

### House roof
Анализ последних трех закрытых свечей на условие того, чтобы центаральная свеча пробивала канал сверзу/снизу, а так же, чтобы предсказания для центральной свечи были больше/меньше по отношению к крайним.
